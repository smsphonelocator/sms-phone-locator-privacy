...
Le téléphone reçoit un SMS contenant un code.

L’application vérifie que le code est valide.

Si oui :

elle active la géolocalisation,

récupère la position,

et renvoie la position par SMS uniquement au numéro qui a envoyé la demande.
...
The phone receives an SMS containing a command code.
